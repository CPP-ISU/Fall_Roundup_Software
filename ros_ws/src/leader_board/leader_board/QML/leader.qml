...
ApplicationWindow {
    ...
    Row{
        Rectangle{
            ...
            Rectangle{
                ...
                Text{
                    ...
                    text:dataModel.leaderBoard[0].class_name
        ...
        ListView{
            y:parent.height/8
            id:listView1
            model:dataModel.leaderBoard[0].pulls
            width:parent.width
            height:parent.height
            delegate:Rectangle{
                color:"#FF0000"
                width:listView1.width
                height: listView1.height / dataModel.leaderBoard[0].pulls.length
                Rectangle{
                    width:parent.width/3
                    height:parent.height
                    color: "#222222"
    ...
    Rectangle{
            ...
            Rectangle{
                ...
                Text{
                    anchors.centerIn: parent
                    text:dataModel.leaderBoard[1].class_name
                    font.pointSize: parent.height / 3
                    color: "#FFFFFF"
                }
            }
        ...
        ListView{
            ...
            y:parent.height/8
            id:listView2
            model:dataModel.leaderBoard[1].pulls
            width:parent.width
            height:parent.height
            delegate:Rectangle{
                color:"#FF0000"
                width:listView1.width
                height: listView1.height / dataModel.leaderBoard[1].pulls.length
                Rectangle{
                    width:parent.width/3
                    height:parent.height
                    color: "#222222"
